...
save(rt, file="/home/philipp/Dropbox/uni_dokumente_dropbox/dissertation/seminars/icss_zuerich/data/tweets_us_20200422.Rda")
```

```{r,echo=TRUE}
library(rtweet)
## Or: load pre-downloaded Tweets
load("/home/philipp/Dropbox/uni_dokumente_dropbox/dissertation/seminars/icss_zuerich/data/tweets_us_20200422.Rda")
...
info <- accounts_info[,c("user_id","protected","followers_count","friends_count","statuses_count","favourites_count","account_created_at","verified")]
head(info)
